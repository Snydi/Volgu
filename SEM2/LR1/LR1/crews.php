            ...
            <tr>
                ...
                if(isset($crewsresult))
                    foreach ($crewsresult as $item) {
                        ...
                        echo '<td>'.'<a type="submit" class="btn btn-danger delete" href ="?del='.$item['id'].'&img='.$item['img_path'].'">Удалить</a>'.'</td>';
                        echo '</tr>' . " ";
                    }
                ?>
            </tr>
...
<form class="row row-cols-lg-auto g-3 align-items-center" name="crews" method="post" action="crews.php" enctype="multipart/form-data">
     ...
     <div class="col-4">
            ...
            <input type="text" required class="form-control" placeholder="Бригада" name="crews" maxlength="60"
                   value="<?php if(isset($_POST['crews'])) echo htmlspecialchars($_POST['crews']); else echo ""?>">
            </div>
            <div class="input-group">
